						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									...
									@if($product->publication_status)
									<a class="btn btn-unsuccess" href="{{URL::to('/admin/product/'.$product->product_id.'/unactive')}}">
										<i class="halflings-icon white remove"></i>  
									</a>
									@else
									<a class="btn btn-success" href="{{URL::to('/admin/product/'.$product->product_id.'/active')}}">
									...
									<a class="btn btn-info" href="{{URL::to('/admin/category/'.$product->product_id.'/edit')}}">
										<i class="halflings-icon white edit"></i>  
									</a>

									<a 
									class="btn btn-danger" 
									href="{{URL::to('/admin/product/'.$product->product_id.'/delete')}}"
