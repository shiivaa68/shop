						  ...
						  <tbody>
							...
							<tr>
								...
								<td class="center">
									...
									@if($manufacture->publication_status)
									<a class="btn btn-unsuccess" href="{{URL::to('/admin/manufacture/'.$manufacture->manufacture_id.'/unactive')}}">
									...
									<a class="btn btn-info" href="{{URL::to('/admin/manufacture/'.$manufacture->manufacture_id.'/update')}}">
										<i class="halflings-icon white edit"></i>  
									</a>

									<a 
									href="{{URL::to('/admin/manufacture/'.$manufacture->manufacture_id.'/delete')}}"
